...
class custom_sites_collection_test extends \phpbb_test_case
{
	...
	public function test_get_collection()
	{
		...
		$this->assertNotContains('phpBB/ext/phpbb/mediaembed/collection/sites/mastodon.yml', $collection);
		$this->assertNotContains('phpBB/ext/phpbb/mediaembed/collection/sites/vk.yml', $collection);
