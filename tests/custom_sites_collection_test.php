...
class custom_sites_collection_test extends \phpbb_test_case
{
	...
	public function test_get_collection()
	{
		...
		$this->assertContains('phpBB/ext/phpbb/mediaembed/collection/sites/applemusic.yml', $collection);
		$this->assertContains('phpBB/ext/phpbb/mediaembed/collection/sites/bilibili.yml', $collection);
		$this->assertContains('phpBB/ext/phpbb/mediaembed/collection/sites/kick.yml', $collection);
		...
		$this->assertContains('phpBB/ext/phpbb/mediaembed/collection/sites/yamusic.yml', $collection);
	}
}
