...
$lang = array_merge($lang, [
	...
	'ACP_MEDIA_FULL_WIDTH'				=> 'Full width content',
	...
	'ACP_MEDIA_MAX_WIDTH_EXPLAIN'		=> 'Use this field to define custom max-width values for individual sites. This will override the default size and the full width option above. Enter each site id on a new line, using the format <samp>siteId:width</samp> with either <samp>px</samp> or <samp>%</samp>.<br><br>For example:<br><samp>youtube:80%</samp><br><samp>funnyordie:480px</samp><br><br><i>Tip: Hover your mouse over a site on the Manage sites page to reveal the site id name you should use here.</i>',
	...
	'ACP_MEDIA_ERROR_MSG'				=> 'The following error was encountered:<br><br>%s',
	'ACP_MEDIA_INVALID_SITE'			=> '“%1$s:%2$s” contained an invalid site id',
	'ACP_MEDIA_INVALID_WIDTH'			=> '“%1$s:%2$s” contained an invalid width',
