...
$lang = array_merge($lang, [
	...
	'ACP_MEDIA_FULL_WIDTH'				=> 'Full width Media Embeds',
	'ACP_MEDIA_FULL_WIDTH_EXPLAIN'		=> 'Enable this to expand Media Embed content to a maximum width of 100%, filling the full width of the post content area while maintaining its native aspect ratio.',
	'ACP_MEDIA_MAX_WIDTH'				=> 'Custom max-width Media Embeds',
	'ACP_MEDIA_MAX_WIDTH_EXPLAIN'		=> 'Use this field to define custom max-width values for individual site. This will override the default size or the full width option above. Enter each site on a new line, using the format <samp>site:width</samp> using either <samp>px</samp> or <samp>%</samp>. For example:<br><br><samp>youtube:80%</samp><br><samp>vimeo:480px</samp>',
